                    ...
                    <div class="menu-edit ">
                        <div id="nav-menu-header">
                            <div class="major-publishing-actions">
                                ...
                                <div class="publishing-action">
                                    <input type="submit" value="<?php _e('Save Roles and Capabilities', $this->translation_domain); ?>" class="button button-primary menu-save" id="roles-cap-save_menu_header" name="save_role_cap" >
                                </div>
                            </div>
                        </div>
                        <div id="post-body">
                        ...
                        <div id="nav-menu-footer">
                            <div class="major-publishing-actions solvease-pc">
                                <div class="publishing-action">
                                    <input type="submit" value="<?php _e('Save Roles and Capabilities', $this->translation_domain); ?>" class="button button-primary menu-save" id="roles-cap-save_menu_headersave_menu_header" name="save_role_cap" >
                                </div>
                            </div>
                        </div>
                    </div>
